...
logger = logging.getLogger("xpublish-api.auth")
...
class KeycloakJWTValidator:
    ...
    async def _get_jwks_url(self) -> str:
        ...
        openid_cfg_url = f"{config.KEYCLOAK_ISSUER_URL}/.well-known/openid-configuration"
...
async def resolve_identity(request: Request) -> AuthIdentity:
    ...
    return AuthIdentity(subject="anonymous", auth_type="anonymous")
