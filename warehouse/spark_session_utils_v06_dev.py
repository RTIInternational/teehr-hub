...
# EXECUTOR_NAMESPACE_NAME = os.environ["TEEHR_NAMESPACE"]
...
def create_spark_session(
    ...
    remote_warehouse_dir: str = REMOTE_WAREHOUSE_S3_PATH,
    remote_catalog_name: str = REMOTE_CATALOG_NAME,
    remote_catalog_type: str = REMOTE_CATALOG_TYPE,
    remote_catalog_uri: str = REMOTE_CATALOG_REST_URI,
