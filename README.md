...
3) Click on `update-forecast-metrics-table`. In the upper right corner select Run > Quick Run. Run with the default parameters.

4) Click on `update-joined-forecast-table`. In the upper right corner select Run > Quick Run. Run with the default parameters.
